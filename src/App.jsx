  ...
  return (
    <div className="min-h-screen bg-prestige text-blanco-hueso font-sans selection:bg-blanco-hueso selection:text-verde-bosque overflow-x-hidden">
      ...
      <header className="container mx-auto px-6 md:px-8 py-24 md:py-48 flex flex-col items-center text-center relative">
        ...
        <Reveal>
          <p className="text-base md:text-2xl text-blanco-hueso/90 max-w-4xl mb-12 md:mb-16 leading-relaxed font-serif italic">
        ...
        <motion.div 
          ...
          className="flex flex-col sm:flex-row gap-8 md:gap-10 items-center"
        >
          <a href="https://wa.link/nofyhp" className="text-white border-b border-white/40 pb-2 text-xs md:text-sm uppercase tracking-[0.3em] font-bold hover:border-white transition-all">
            Iniciar Auditoría
          </a>
      ...
      <section id="ventajas" className="py-24 md:py-48 bg-white/2 backdrop-blur-3xl border-y border-white/5 relative overflow-hidden">
        <div className="container mx-auto px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
            <Reveal>
              <h2 className="text-3xl sm:text-5xl md:text-7xl font-serif font-bold leading-tight mb-8 md:mb-10 text-white">
                Tu visión merece <br/> 
                <span className="italic font-normal opacity-50">distinción absoluta.</span>
              </h2>
              <p className="text-[10px] md:text-[11px] opacity-60 max-w-md font-sans leading-loose tracking-widest uppercase mb-12 lg:mb-0">
      ...
      {/* MAPA DE GOOGLE MAPS - NUEVA SECCIÓN */}
      <section className="bg-verde-bosque py-24 border-b border-white/5">
        <div className="container mx-auto px-6 md:px-8">
          <Reveal>
            <div className="max-w-7xl mx-auto overflow-hidden border border-white/10 grayscale contrast-125 hover:grayscale-0 transition-all duration-1000 shadow-2xl">
              <iframe 
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-7xl mx-auto">
          {[
            ...
            <motion.div 
              ...
              className="p-8 md:p-16 bg-white/[0.03] border border-white/5 relative overflow-hidden group hover:bg-white/[0.05] transition-all"
            >
      ...
      {/* TERMINOS Y CONDICIONES - TEXT CLARITY */}
      <section id="terminos" className="py-24 md:py-48 bg-white/2 border-t border-white/5">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <Reveal>
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-serif font-bold mb-16 md:mb-24 text-center tracking-tighter text-white">
              TÉRMINOS Y CONDICIONES <br/>
              <span className="italic font-normal opacity-40 text-xl md:text-3xl">— DE SERVICIO PIVOT —</span>
            </h2>
          </Reveal>

          <div className="space-y-12 md:space-y-20 font-sans text-sm md:text-base leading-relaxed text-blanco-hueso/80">
            {[
              ...
              { t: "5. CONFIDENCIALIDAD", p: "PIVOT mantiene estricta confidencialidad sobre datos de facturación y estrategias comerciales bajo normativas de Protección de Datos Personales." },
              ...
              <Reveal key={i}>
                ...
                {sec.list && (
                  <ul className="space-y-4 md:space-y-6 pl-4 md:pl-6 border-l border-white/20">
                    {sec.list.map((item, j) => <li key={j} className="text-sm"><strong>•</strong> {item}</li>)}
                  </ul>
                )}
              </Reveal>
            ))}
